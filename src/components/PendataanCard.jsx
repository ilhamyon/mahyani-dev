    ...
    >
      ...
      <div style={{ marginTop: 10 }}>
        ...
        <Row gutter={12} style={{ marginTop: 8 }}>
          <Col span={8}>
            <img src={item.foto_depan} alt="Depan" style={{ width: '100%', borderRadius: 8 }} />
            <p style={{ textAlign: 'center', marginTop: 4 }}>Depan</p>
          </Col>
          <Col span={8}>
            <img src={item.foto_samping} alt="Samping" style={{ width: '100%', borderRadius: 8 }} />
            <p style={{ textAlign: 'center', marginTop: 4 }}>Samping</p>
          </Col>
          <Col span={8}>
            <img src={item.foto_belakang} alt="Belakang" style={{ width: '100%', borderRadius: 8 }} />
