...
const createSanityUser = async (baznas_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-baznas', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: baznas_userData.name,
              email: baznas_userData.email,
              password: baznas_userData.password,
              type: baznas_userData.type,
            },
          },
        ],
      }),
